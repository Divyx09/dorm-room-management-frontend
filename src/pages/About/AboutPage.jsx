          ...
          <div className='row align-items-center'>
            <div className='col-lg-6'>
              ...
              <p className='section-text mb-4'>
                At DormMate, we believe every student deserves a safe,
                comfortable, and welcoming place to call home during their
                academic journey. Our mission is to simplify the student housing
                experience through innovative technology and community-driven
                solutions.
              </p>
            ...
            <div className='col-lg-6'>
              <div className='stats-grid'>
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className='stat-card text-center p-4 bg-white rounded-3 shadow-sm'
                  >
          ...
          <div className='row g-4'>
            <div className='col-lg-3 col-md-6'>
              <div className='value-card text-center p-4 bg-white rounded-3 shadow-sm'>
                ...
                <p className='value-text'>
                  Building reliable connections within our community
                </p>
              </div>
            </div>
            <div className='col-lg-3 col-md-6'>
              <div className='value-card text-center p-4 bg-white rounded-3 shadow-sm'>
                ...
                <p className='value-text'>
                  Fostering meaningful relationships among students
                </p>
              </div>
            </div>
            <div className='col-lg-3 col-md-6'>
            ...
            <div className='col-lg-3 col-md-6'>
              <div className='value-card text-center p-4 bg-white rounded-3 shadow-sm'>
                ...
                <p className='value-text'>
                  Putting students' needs first in everything we do
                </p>
              </div>
            </div>
          </div>
